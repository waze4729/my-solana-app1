...
<body>
    ...
    <div class="terminal-container">
        ...
        <div class="stats-section">
            ...
            <div class="stat-card">
                <div class="stat-label">BLOCKS REVEALED</div>
                <div class="stat-value" id="blocks-revealed">0/100</div>
            </div>
            <div class="stat-card">
                <div class="stat-label">GREEN BLOCKS</div>
                <div class="stat-value" id="green-blocks">0</div>
            </div>
        </div>
    ...
    <script>
        ...
        function updateGame(data) {
            ...
            document.getElementById('blocks-revealed').textContent = 
                \`\${gameData.currentBlockIndex}/\${gameData.totalBlocks}\`;
            
            const greenBlocksCount = gameData.blocks.filter(block => block.color === 'green').length;
            document.getElementById('green-blocks').textContent = greenBlocksCount;
